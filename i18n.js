...
(function () {
  ...
  const T = {
    ja: {
      ...
      'nav.cop': 'COP ダッシュボード',
      'nav.conflict': '競合解消',
      'nav.datafeed': 'データフィード',
      'nav.trend': 'トレンド予測',

      // ── index card4 ───────────────────────────────────────────────
      'index.card4.title': 'トレンド分析・予測',
      'index.card4.desc': 'フェーズ進行・YoY比較・AI予測・閾値管理を統合したダッシュボード。',

      // ── trend-forecast ────────────────────────────────────────────
      'trend.title': 'DDCR — トレンド分析・予測（モックアップ）',
      'trend.heading': 'Trends & Forecasts',
      'trend.time.label': '発災後経過時間:',
      'trend.time.unit': '時間',
      'trend.panel1.heading': 'CPS4D フェーズトラッカー',
      'trend.phase.prevention': '予防',
      'trend.phase.response': '対応',
      'trend.phase.recovery': '回復',
      'trend.phase.sub.signs': '兆候',
      'trend.phase.sub.initial': '初動',
      'trend.phase.sub.spread': '拡大',
      'trend.phase.sub.subsiding': '収束',
      'trend.phase.convergence': '収束予測: +18h',
      'trend.panel2.heading': 'YoY 比較（対前年比）',
      'trend.yoy.picker.label': 'ベースライン:',
      'trend.yoy.picker.median': '過去3年中央値',
      'trend.yoy.picker.lastyear': '前年同日',
      'trend.yoy.picker.similar': '類似災害',
      'trend.yoy.legend.current': '現在値',
      'trend.yoy.legend.baseline': 'ベースライン',
      'trend.panel3.heading': '避難者数 — 予測バンド (0〜72h)',
      'trend.pred.legend.predicted': '予測値',
      'trend.pred.legend.actual': '実測値',
      'trend.pred.legend.interval': '信頼区間 95%',
      'trend.panel4.heading': '閾値コンソール + リードタイム',
      'trend.gauge.capacity': '収容率',
      'trend.gauge.supply': '物資充足',
      'trend.gauge.comm': '通信障害率',
      'trend.gauge.threshold': '閾値',
      'trend.gauge.current': '現在',
      'trend.ai.suggest': 'AI 提案',
      'trend.ai.approve': '✓ 承認',
      'trend.ai.in': 'まで',
      'trend.leadtime.heading': 'リードタイム履歴',
      'trend.sim.label': '閾値シミュレーター',
    ...
    en: {
      ...
      // ── nav tabs ──────────────────────────────────────────────────
      'nav.cop': 'COP Dashboard',
      'nav.conflict': 'Conflict Resolution',
      'nav.datafeed': 'Data Feed',
      'nav.trend': 'Trends & Forecasts',

      // ── index card4 ───────────────────────────────────────────────
      'index.card4.title': 'Trends & Forecasts',
      'index.card4.desc': 'Integrated dashboard for phase progression, YoY comparison, AI prediction, and threshold management.',

      // ── trend-forecast ────────────────────────────────────────────
      'trend.title': 'DDCR — Trends & Forecasts (Mockup)',
      'trend.heading': 'Trends & Forecasts',
      'trend.time.label': 'Time since disaster:',
      'trend.time.unit': 'hours',
      'trend.panel1.heading': 'CPS4D Phase Tracker',
      'trend.phase.prevention': 'Prevention',
      'trend.phase.response': 'Response',
      'trend.phase.recovery': 'Recovery',
      'trend.phase.sub.signs': 'Signs',
      'trend.phase.sub.initial': 'Initial',
      'trend.phase.sub.spread': 'Spread',
      'trend.phase.sub.subsiding': 'Subsiding',
      'trend.phase.convergence': 'Convergence est.: +18h',
      'trend.panel2.heading': 'YoY Comparison',
      'trend.yoy.picker.label': 'Baseline:',
      'trend.yoy.picker.median': 'Past 3-yr median',
      'trend.yoy.picker.lastyear': 'Same day last year',
      'trend.yoy.picker.similar': 'Similar disaster',
      'trend.yoy.legend.current': 'Current',
      'trend.yoy.legend.baseline': 'Baseline',
      'trend.panel3.heading': 'Evacuee Count — Prediction Band (0–72h)',
      'trend.pred.legend.predicted': 'Predicted',
      'trend.pred.legend.actual': 'Actual',
      'trend.pred.legend.interval': '95% confidence interval',
      'trend.panel4.heading': 'Threshold Console + Lead Time',
      'trend.gauge.capacity': 'Occupancy Rate',
      'trend.gauge.supply': 'Supply Sufficiency',
      'trend.gauge.comm': 'Comm. Failure Rate',
      'trend.gauge.threshold': 'Threshold',
      'trend.gauge.current': 'Current',
      'trend.ai.suggest': 'AI Suggestion',
      'trend.ai.approve': '✓ Approve',
      'trend.ai.in': 'until',
      'trend.leadtime.heading': 'Lead Time History',
      'trend.sim.label': 'Threshold Simulator',
